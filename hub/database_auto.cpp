...
void create_admin_db()
{
	strcpy(admin[0].login,"admin");
	strcpy(admin[0].password,"admin");
	admin[0].level = 0;

	admin_max = 0;
	printf("database created- purpose:admin\n");
}

void create_guild_db()
{
	int i,k,j;

    //Rogue 0
	i=0;
	strcpy(guild[i].name,"Rogue");
	strcpy(guild[i].owner,"Col Karter");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	strcpy(guild[i].rank_name[1],"Grunt");
	strcpy(guild[i].rank_name[2],"Leader");
	strcpy(guild[i].rank_name[3],"Recruiter");
	strcpy(guild[i].rank_name[4],"General");
	strcpy(guild[i].rank_name[5],"Owner");
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"");
	strcpy(guild[i].enemy[1],"");
	strcpy(guild[i].enemy[0],"Klyn");

	//Trader 1
	i++;
	strcpy(guild[i].name,"Trader");
	strcpy(guild[i].owner,"Col Karter");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	...
	strcpy(guild[i].enemy[2],"");
	strcpy(guild[i].enemy[1],"");
	strcpy(guild[i].enemy[0],"");

	//Militia 2
	i++;
	strcpy(guild[i].name,"Militia");
	strcpy(guild[i].owner,"Col Darus");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"Rin");
	strcpy(guild[i].enemy[1],"Klyn");
	strcpy(guild[i].enemy[0],"Miner");

	//Rin 3
	i++;
	strcpy(guild[i].name,"Rin");
	strcpy(guild[i].owner,"Ri Beedo");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"Trader");
	strcpy(guild[i].enemy[1],"Miner");
	strcpy(guild[i].enemy[0],"Klyn");

    //Klyn 4
	i++;
	strcpy(guild[i].name,"Klyn");
	strcpy(guild[i].owner,"Zinpo Brue");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"Militia");
	strcpy(guild[i].enemy[1],"Trader");
	strcpy(guild[i].enemy[0],"Rin");

	//Kaydin 5
	i++;
	strcpy(guild[i].name,"Kaydin");
	strcpy(guild[i].owner,"Pootar");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"Miner");
	strcpy(guild[i].enemy[1],"Trader");
	strcpy(guild[i].enemy[0],"Klyn");

	//Miner 6
	i++;
	strcpy(guild[i].name,"Miner");
	strcpy(guild[i].owner,"Ki Zar");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	strcpy(guild[i].enemy[2],"Rin");
	strcpy(guild[i].enemy[1],"Klyn");
	strcpy(guild[i].enemy[0],"Asteroid");

	//Asteriod 7
	i++;
	strcpy(guild[i].name,"Asteriod");
	strcpy(guild[i].owner,"Asteroid 1");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	//Gen Raider 8
	i++;
	strcpy(guild[i].name,"Gen Raider");
	strcpy(guild[i].owner,"KinTok");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"Gen Crusader");
	strcpy(guild[i].enemy[1],"Trader");
	strcpy(guild[i].enemy[0],"Rogue");

	//Gen Crusader 9
	i++;
	strcpy(guild[i].name,"Gen Crusader");
	strcpy(guild[i].owner,"Genix Thal");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"Gen Raider");
	strcpy(guild[i].enemy[1],"Pirate");
	strcpy(guild[i].enemy[0],"Rogue");

	//Pirate 10
	i++;
	strcpy(guild[i].name,"Pirate");
	strcpy(guild[i].owner,"Lark");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	for(k=0;k<6;k++)
		for(j=0;j<5;j++)
			guild[i].rank_allow[k][j] = 0;
	strcpy(guild[i].enemy[2],"Rogue");
	strcpy(guild[i].enemy[1],"Trader");
	strcpy(guild[i].enemy[0],"Gen Crusader");

	//Li Sentry 11
	i++;
	strcpy(guild[i].name,"Li Sentry");
	strcpy(guild[i].owner,"Lex Jentor");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	//Sentry Guard 12
	i++;
	strcpy(guild[i].name,"Sentry Guard");
	strcpy(guild[i].owner,"Gen Kohl");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	//High Council 13
	i++;
	strcpy(guild[i].name,"High Council");
	strcpy(guild[i].owner,"Gen Norman");
	strcpy(guild[i].website,"www.lightspace.tk");
	guild[i].bank_money = 50000;
	guild[i].bank_lend = 100000;
	strcpy(guild[i].rank_name[0],"Scout");
	...
	strcpy(guild[i].enemy[2],"Militia");
	strcpy(guild[i].enemy[1],"Klyn");
	strcpy(guild[i].enemy[0],"Trader");

	guild_max = i;
	printf("database created- purpose:guild\n");
}

void create_server_db()
{
	strcpy(server[0].login,"login_name");
	strcpy(server[0].password,"login_password");
	strcpy(server[0].servername,"LightSpace");
	strcpy(server[0].real_address,"");
	server[0].x = 50;
	server[0].y = 50;

	server_max = 0;
	printf("database created- purpose:server\n");
}
...
{
	server[i].zone[k].sector[z].planet = planet;
	server[i].zone[k].sector[z].shield = shield;
	server[i].zone[k].sector[z].x = x;
	server[i].zone[k].sector[z].y = y;
	server[i].zone[k].sector[z].sector[0] = sec1;
	server[i].zone[k].sector[z].sector[1] = sec2;
	server[i].zone[k].sector[z].sector[2] = sec3;
	server[i].zone[k].sector[z].sector[3] = sec4;
	server[i].zone[k].sector[z].sector[4] = sec5;
	server[i].zone[k].sector[z].range = range;
	server[i].zone[k].sector[z].zone = -1;
}
...
{
	strcpy(server[i].planet[k].name,planet_name);
	strcpy(server[i].planet[k].guild,guild_name);
	strcpy(server[i].planet[k].bar_name,bar_name);
	server[i].planet[k].is_gate = is_gate;
	server[i].planet[k].is_home = is_home;
	server[i].planet[k].has_guild_halls = has_guild_halls;
	server[i].planet[k].home_class = home_class;
	server[i].planet[k].is_server_gate = is_server_gate;
}
...
{
	strcpy(server[i].gun[k].name,weapon_name);
	server[i].gun[k].cost 		= cost;
	server[i].gun[k].damage 	= damage;
	server[i].gun[k].speed 		= speed;
	server[i].gun[k].accuracy 	= accuracy;
	server[i].gun[k].exp_static 		= exp_static;
	server[i].gun[k].exp_added 		= exp_added;
	server[i].gun[k].tech_level 		= tech_level;
	server[i].gun[k].type 	= type;
}
...
{
	strcpy(server[i].missile[k].name,weapon_name);
	server[i].missile[k].cost 		= cost;
	server[i].missile[k].damage 		= damage;
	server[i].missile[k].speed 		= speed;
	server[i].missile[k].accuracy 		= accuracy;
	server[i].missile[k].exp_static 		= exp_static;
	server[i].missile[k].exp_added 		= exp_added;
	server[i].missile[k].tech_level 		= tech_level;
	server[i].missile[k].type 	= type;
}
...
{
	server[i].ship[k].cost[z]		= cost;
	server[i].ship[k].exp[z]		= exp;
	server[i].ship[k].hull[z]		= hull;
	server[i].ship[k].shield[z]		= shield;
	server[i].ship[k].evasion[z]		= evasion;
	server[i].ship[k].speed[z]		= speed;
	server[i].ship[k].range[z]		= range;
	server[i].ship[k].cargo[z]		= cargo;
	server[i].ship[k].gun_ammount[z]	= guns;
	server[i].ship[k].missile_ammount[z]	= missiles;
	server[i].ship[k].misc_ammount[z]	= miscs;
}
...
{
	strcpy(server[s].bot_type[i].name,name);
	strcpy(server[s].bot_type[i].guild,guild);
	server[s].bot_type[i].bot_class = the_class;
	server[s].bot_type[i].aggression = aggression;
	server[s].bot_type[i].intelligence = intelligence;
	server[s].bot_type[i].zone = zone;
	server[s].bot_type[i].field_type = field_type;
}

void set_server_bot_info(int s, int i, int k, char *name, int ship_class, int ship_kind, int gun, int def_multi, int exp)
{
	strcpy(server[s].bot_type[i].bot[k].name,name);
	server[s].bot_type[i].bot[k].ship_class = ship_class;
	server[s].bot_type[i].bot[k].ship_kind = ship_kind;
	server[s].bot_type[i].bot[k].gun = gun;
	server[s].bot_type[i].bot[k].def_multi = def_multi;
	server[s].bot_type[i].bot[k].exp = exp;
}

void set_server_satellite_default(int s, int p, int level, int g, int gun, int missile)
{
	int i;

	server[s].planet[p].sat.level = level;
	server[s].planet[p].sat.guild_id = g;
	server[s].planet[p].sat.money = 400000;
	server[s].planet[p].sat.money_collected = 0;
	server[s].planet[p].sat.hull = level * SAT_HULL_INC;

	for(i=0;i<SAT_LEVEL_MAX * SAT_GUN_INC;i++)
	{
		server[s].planet[p].sat.gun[i] = gun;
		server[s].planet[p].sat.gun_destroyed[i] = 0;
	}
	for(i=0;i<SAT_LEVEL_MAX * SAT_MISSILE_INC;i++)
	{
		server[s].planet[p].sat.missile[i] = missile;
		server[s].planet[p].sat.missile_left[i] = 4;
	}
}

void create_server_bot_db(int s)
{
	int i, j, k;
	...
	for(i=0;i<BOT_TYPE_MAX;i++)
		for(k=0;k<SECTOR_MAX;k++)
			server[s].bot_type[i].sector[k] = 0;

	i = 0;
	set_server_bot_type_info(s,0,-1,"Militia","Militia",1,1,0,1,0);
	server[s].bot_type[i].sector[0] = 1;
	server[s].bot_type[i].sector[1] = 1;
	server[s].bot_type[i].sector[2] = 1;
	server[s].bot_type[i].sector[3] = 1;
	server[s].bot_type[i].sector[4] = 1;
	server[s].bot_type[i].sector[5] = 1;
	server[s].bot_type[i].sector[6] = 1;
	server[s].bot_type[i].sector[7] = 1;
	server[s].bot_type[i].sector[8] = 1;
	server[s].bot_type[i].sector[9] = 1;
	server[s].bot_type[i].sector[10] = 1;
	server[s].bot_type[i].sector[11] = 1;
	server[s].bot_type[i].sector[12] = 1;
	server[s].bot_type[i].sector[17] = 1;
	server[s].bot_type[i].sector[18] = 1;
	server[s].bot_type[i].sector[19] = 1;
	server[s].bot_type[i].sector[29] = 1;
	...
	i=1;
	for(k=0;k<46;k++)
		server[s].bot_type[i].sector[k] = 1;

	k=0;
	set_server_bot_info(s,1,k++,"Crinlib",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Fargul",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Greeno",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Kin Sing",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Koodar",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Meegin",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Pootar",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Zinpo Brue",0,0,10,1,20);
	set_server_bot_info(s,1,k++,"Zwillin",0,0,10,1,20);

	set_server_bot_info(s,1,k++,"Brynch",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Dansus",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Fliggit",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Gillin",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Grin Chou",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Keelos",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Pintok",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Tevlar",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Quaze",1,1,20,1,50);
	set_server_bot_info(s,1,k++,"Wishgin",1,1,20,1,50);

	set_server_bot_info(s,1,k++,"Cowgin Jay",1,3,30,1,70);
	set_server_bot_info(s,1,k++,"Kraygol",1,3,30,1,70);
	set_server_bot_info(s,1,k++,"Vaycrant",1,3,30,1,70);
	set_server_bot_info(s,1,k++,"Visik",1,3,30,1,70);

	set_server_bot_info(s,1,k++,"Dinsow Ca",3,1,30,1,80);
	set_server_bot_info(s,1,k++,"Tweel",3,1,30,1,80);
	set_server_bot_info(s,1,k++,"Versi",3,1,30,1,80);
	set_server_bot_info(s,1,k++,"Weego",3,1,30,1,80);

	i=2;
	set_server_bot_type_info(s,2,-1,"Rin","Rin",2,3,1,1,0);
	for(k=30;k<46;k++)
		server[s].bot_type[i].sector[k] = 1;
	server[s].bot_type[i].sector[15] = 1;
	server[s].bot_type[i].sector[16] = 1;
	server[s].bot_type[i].sector[38] = 0;

	k=0;
	set_server_bot_info(s,2,k++,"Ri Beedo",3,6,100,1,400);
	set_server_bot_info(s,2,k++,"Ri Bindelo",3,6,100,1,400);

	set_server_bot_info(s,2,k++,"Ri Caliban",3,5,70,1,350);
	set_server_bot_info(s,2,k++,"Ri Faucan",3,5,70,1,350);
	set_server_bot_info(s,2,k++,"Ri Feste",3,5,70,1,350);

	set_server_bot_info(s,2,k++,"Ri Foogo",3,3,40,1,250);
	set_server_bot_info(s,2,k++,"Ri Jay Ko",3,3,40,1,250);
	set_server_bot_info(s,2,k++,"Ri Gremio",3,3,40,1,250);
	set_server_bot_info(s,2,k++,"Ri Joka",3,3,40,1,250);

	set_server_bot_info(s,2,k++,"Ri Kado",3,1,30,1,200);
	set_server_bot_info(s,2,k++,"Ri Kudog",3,1,30,1,200);
	set_server_bot_info(s,2,k++,"Ri Ky Din",3,1,30,1,200);
	set_server_bot_info(s,2,k++,"Ri Ny Godar",3,1,30,1,200);

	set_server_bot_info(s,2,k++,"Ri Nyin",3,0,20,1,150);
	set_server_bot_info(s,2,k++,"Ri Nyphor",3,0,20,1,150);
	set_server_bot_info(s,2,k++,"Ri Siward",3,0,20,1,150);
	set_server_bot_info(s,2,k++,"Ri Trinculo",3,0,20,1,150);
	set_server_bot_info(s,2,k++,"Ri Tyvio",3,0,20,1,150);
	set_server_bot_info(s,2,k++,"Ri Veeg",3,0,20,1,150);


	//void set_server_bot_type_info(int i, int dum, char *name, char *guild, int class, int aggression, int intelligence, int zone, int field_type)
	i=3;
	set_server_bot_type_info(s,i,-1,"Asteroid","Asteroid",0,0,1,1,1);
	server[s].bot_type[i].sector[25] = 1;
	server[s].bot_type[i].sector[26] = 1;
	server[s].bot_type[i].sector[27] = 1;
	server[s].bot_type[i].sector[28] = 1;
	...
	i=4;
	set_server_bot_type_info(s,i,-1,"Miner","Miner",2,3,1,1,0);
	server[s].bot_type[i].sector[24] = 1;
	server[s].bot_type[i].sector[25] = 1;
	server[s].bot_type[i].sector[26] = 1;
	server[s].bot_type[i].sector[27] = 1;
	server[s].bot_type[i].sector[28] = 1;
	...
	k=0;
	set_server_bot_info(s,i,k++,"Ki Zar",4,6,110,1,200);
	set_server_bot_info(s,i,k++,"Ki Fet",4,6,110,1,200);

	set_server_bot_info(s,i,k++,"Ki Qune",4,5,80,1,180);
	set_server_bot_info(s,i,k++,"Ki Cado",4,5,80,1,180);
	set_server_bot_info(s,i,k++,"Ki Fic",4,5,80,1,180);

	set_server_bot_info(s,i,k++,"Ki Hoor",4,4,70,1,170);

	set_server_bot_info(s,i,k++,"Ki Nani",4,3,60,1,150);
	set_server_bot_info(s,i,k++,"Ki Aldrin",4,3,60,1,150);
	set_server_bot_info(s,i,k++,"Ki Jace",4,3,60,1,150);
	set_server_bot_info(s,i,k++,"Ki Goot",4,3,60,1,150);

	set_server_bot_info(s,i,k++,"Ki Tore",4,1,40,1,120);
	set_server_bot_info(s,i,k++,"Ki Jortus",4,1,40,1,120);
	set_server_bot_info(s,i,k++,"Ki Cru",4,1,40,1,120);
	set_server_bot_info(s,i,k++,"Ki Loon",4,1,40,1,120);
	set_server_bot_info(s,i,k++,"Ki Cooper",4,1,40,1,120);

	set_server_bot_info(s,i,k++,"Ki Konee",4,0,40,1,100);
	set_server_bot_info(s,i,k++,"Ki Heet",4,0,40,1,100);
	set_server_bot_info(s,i,k++,"Ki Isacc",4,0,40,1,100);
	set_server_bot_info(s,i,k++,"Ki Yeager",4,0,40,1,100);
	set_server_bot_info(s,i,k++,"Ki Lootus",4,0,40,1,100);
	set_server_bot_info(s,i,k++,"Ki Weet",4,0,40,1,100);

	i=5;
	set_server_bot_type_info(s,i,-1,"Gen Raider","Gen Raider",2,2,0,0,0);
	for(j=36;j<96;j++)
		server[s].bot_type[i].sector[j] = 1;
	server[s].bot_type[i].sector[23] = 1;
	server[s].bot_type[i].sector[28] = 1;
	server[s].bot_type[i].sector[31] = 1;
	server[s].bot_type[i].sector[15] = 1;

	//void set_server_bot_info(s,int i, int k, char *name, int ship_class, int ship_kind, int gun, int def_multi, int exp)
	k=0;
	set_server_bot_info(s,i,k++,"KinTok",0,6,25,1,70);
	set_server_bot_info(s,i,k++,"Zenik",0,6,25,1,70);
	set_server_bot_info(s,i,k++,"Hclon",0,6,25,1,70);
	set_server_bot_info(s,i,k++,"Trechil",0,6,25,1,70);

	set_server_bot_info(s,i,k++,"Yin Sok",0,5,20,1,60);
	set_server_bot_info(s,i,k++,"Veenik",0,5,20,1,60);
	set_server_bot_info(s,i,k++,"Guo Fin",0,5,20,1,60);
	set_server_bot_info(s,i,k++,"Vonnille",0,5,20,1,60);
	set_server_bot_info(s,i,k++,"Tkeloy",0,5,20,1,60);

	set_server_bot_info(s,i,k++,"Sinik",0,3,10,1,40);
	set_server_bot_info(s,i,k++,"Kez",0,3,10,1,40);
	set_server_bot_info(s,i,k++,"Kin Vine",0,3,10,1,40);
	set_server_bot_info(s,i,k++,"Fi Trol",0,3,10,1,40);
	set_server_bot_info(s,i,k++,"Pontis",0,3,10,1,40);
	set_server_bot_info(s,i,k++,"Ewntice",0,3,10,1,40);

	set_server_bot_info(s,i,k++,"Vync",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Pollic",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Xezic",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Jyke",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Seciz",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Tonis",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Twenol",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Chyr",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Fayr",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Dentroy",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Dar",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Heatch",0,1,10,1,30);
	set_server_bot_info(s,i,k++,"Peeh",0,1,10,1,30);

	set_server_bot_info(s,i,k++,"Wene Tey",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Trollic",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Potic",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Nish",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Lok Tyr",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Decit",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Harst",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Jenst",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Jarn",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Robet",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Shek",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Fendle",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Pohchi",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Stewndor",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Divtr",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Dhoone",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Birn",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Hyat",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Lerr",0,0,5,1,10);
	set_server_bot_info(s,i,k++,"Moul",0,0,5,1,10);

	i=6;
	set_server_bot_type_info(s,i,-1,"Gen Crusader","Gen Crusader",1,1,0,0,0);
	for(j=0;j<96;j++)
		server[s].bot_type[i].sector[j] = 1;
	...
	i=7;
	set_server_bot_type_info(s,i,-1,"Pirate","Pirate",2,3,0,0,0);
	server[s].bot_type[i].sector[101] = 1;
	server[s].bot_type[i].sector[102] = 1;
	server[s].bot_type[i].sector[103] = 1;
	server[s].bot_type[i].sector[104] = 1;
	server[s].bot_type[i].sector[105] = 1;
	server[s].bot_type[i].sector[106] = 1;
	server[s].bot_type[i].sector[117] = 1;
	server[s].bot_type[i].sector[140] = 1;
	server[s].bot_type[i].sector[141] = 1;
	server[s].bot_type[i].sector[125] = 1;
	server[s].bot_type[i].sector[112] = 1;
	server[s].bot_type[i].sector[114] = 1;
	server[s].bot_type[i].sector[115] = 1;
	server[s].bot_type[i].sector[116] = 1;
	server[s].bot_type[i].sector[95] = 1;
	...
	i=9;
	set_server_bot_type_info(s,i,-1,"Gen Asteroid","Asteroid",0,0,1,0,1);
	for(j=193;j<233;j++)
		server[s].bot_type[i].sector[j] = 1;

	//void set_server_bot_info(s,int i, int k, char *name, int ship_class, int ship_kind, int gun, int def_multi)
	k=0;
	set_server_bot_info(s,i,k++,"Gen Asteroid 1",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 2",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 3",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 4",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 5",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 6",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 7",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 8",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 9",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 10",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 11",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 12",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 13",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 14",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 15",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 16",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 17",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 18",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 19",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 20",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 21",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 22",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 23",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 24",0,1,0,1,10);
	set_server_bot_info(s,i,k++,"Gen Asteroid 25",0,1,0,1,10);

	i=10;
	set_server_bot_type_info(s,i,-1,"Li Sentry","Li Sentry",0,3,0,0,0);
	server[s].bot_type[i].sector[75] = 1;
	server[s].bot_type[i].sector[151] = 1;
	server[s].bot_type[i].sector[152] = 1;
	server[s].bot_type[i].sector[153] = 1;
	server[s].bot_type[i].sector[146] = 1;
	server[s].bot_type[i].sector[147] = 1;
	server[s].bot_type[i].sector[148] = 1;
	server[s].bot_type[i].sector[154] = 1;
	server[s].bot_type[i].sector[149] = 1;
	server[s].bot_type[i].sector[157] = 1;
	server[s].bot_type[i].sector[158] = 1;
	server[s].bot_type[i].sector[192] = 1;
	server[s].bot_type[i].sector[150] = 1;
	...
	for(j=0;j<36;j++)
		server[s].bot_type[i].sector[j] = 1;
	server[s].bot_type[i].sector[23] = 0;
	server[s].bot_type[i].sector[15] = 0;
	server[s].bot_type[i].sector[28] = 0;
	server[s].bot_type[i].sector[31] = 0;
	...
	for(j=31;j<42;j++)
		server[s].bot_type[i].sector[j] = 1;
	server[s].bot_type[i].sector[61] = 1;
	server[s].bot_type[i].sector[57] = 1;
	server[s].bot_type[i].sector[53] = 1;
	server[s].bot_type[i].sector[54] = 1;
	...
	//void set_server_bot_type_info(s,int i, int dum, char *name, char *guild, int class, int aggression, int intelligence, int zone, int field_type)
	i=13;
	set_server_bot_type_info(s,i,-1,"High Council","High Council",2,4,0,3,0);
	for(j=0;j<31;j++)
		server[s].bot_type[i].sector[j] = 1;

	//void set_server_bot_info(s,int i, int k, char *name, int ship_class, int ship_kind, int gun, int def_multi, int exp)
	k=0;
	set_server_bot_info(s,i,k++,"Gen Norman",5,7,280,2,600);
	set_server_bot_info(s,i,k++,"Gen Mandable ",5,7,280,2,600);

	set_server_bot_info(s,i,k++,"Col Artemis",5,6,240,2,500);
	set_server_bot_info(s,i,k++,"Col Fudd",5,6,240,2,500);
	set_server_bot_info(s,i,k++,"Col Meed",5,6,240,2,500);

	set_server_bot_info(s,i,k++,"Mjr Kang",5,5,200,2,450);
	set_server_bot_info(s,i,k++,"Mjr Kalun",5,5,200,2,450);
	set_server_bot_info(s,i,k++,"Mjr Kaput",5,5,200,2,450);
	set_server_bot_info(s,i,k++,"Mjr Kleetus",5,5,200,2,450);

	set_server_bot_info(s,i,k++,"Lt Zeleno",5,3,160,2,300);
	set_server_bot_info(s,i,k++,"Lt Kurcho",5,3,160,2,300);
	set_server_bot_info(s,i,k++,"Lt Sedney",5,3,160,2,300);
	set_server_bot_info(s,i,k++,"Lt Larf",5,3,160,2,300);
	set_server_bot_info(s,i,k++,"Lt Tuppe",5,3,160,2,300);
	set_server_bot_info(s,i,k++,"Lt Purt",5,3,160,2,300);

	set_server_bot_info(s,i,k++,"Pvt Jung",5,3,80,2,200);
	set_server_bot_info(s,i,k++,"Pvt Bog",5,3,80,2,200);
	set_server_bot_info(s,i,k++,"Pvt Wirm",5,3,80,2,200);
	set_server_bot_info(s,i,k++,"Pvt Burt",5,3,80,2,200);
	set_server_bot_info(s,i,k++,"Pvt Kunos",5,3,80,2,200);
	set_server_bot_info(s,i,k++,"Pvt Marmar",5,3,80,2,200);
	set_server_bot_info(s,i,k++,"Pvt Pewt",5,3,80,2,200);
	...
	//void set_server_bot_type_info(s,int i, int dum, char *name, char *guild, int class, int aggression, int intelligence, int zone, int field_type)
	i=18;
	set_server_bot_type_info(s,i,-1,"Kaydin","Kaydin",2,3,0,4,0);
	for(j=20;j<127;j++)
		server[s].bot_type[i].sector[j] = 1;
	...
	//void set_server_bot_info(s,int i, int k, char *name, int ship_class, int ship_kind, int gun, int def_multi, int exp)
	k=0;
	set_server_bot_info(s,i,k++,"Kay Tar",6,7,300,1,1700);

	set_server_bot_info(s,i,k++,"Kay Liy",6,6,260,1,1600);
	set_server_bot_info(s,i,k++,"Kay Zeef",6,6,260,1,1600);

	set_server_bot_info(s,i,k++,"Kay Fio",6,5,220,1,1500);
	set_server_bot_info(s,i,k++,"Kay Godin",6,5,220,1,1500);
	set_server_bot_info(s,i,k++,"Kay Rit",6,5,220,1,1500);
	set_server_bot_info(s,i,k++,"Kay Zil",6,5,220,1,1500);

	set_server_bot_info(s,i,k++,"Kay Fli",6,3,180,1,1400);
	set_server_bot_info(s,i,k++,"Kay Sin",6,3,180,1,1400);
	set_server_bot_info(s,i,k++,"Kay Drio",6,3,180,1,1400);
	set_server_bot_info(s,i,k++,"Kay Glow",6,3,180,1,1400);
	set_server_bot_info(s,i,k++,"Kay Trew",6,3,180,1,1400);

	set_server_bot_info(s,i,k++,"Kay Tusc",6,1,120,1,1200);
	set_server_bot_info(s,i,k++,"Kay Trik",6,1,120,1,1200);
	set_server_bot_info(s,i,k++,"Kay Plin",6,1,120,1,1200);
	set_server_bot_info(s,i,k++,"Kay Gli",6,1,120,1,1200);
	set_server_bot_info(s,i,k++,"Kay Quin",6,1,120,1,1200);
	set_server_bot_info(s,i,k++,"Kay Wurt",6,1,120,1,1200);

	//void set_server_bot_type_info(s,int i, int dum, char *name, char *guild, int class, int aggression, int intelligence, int zone, int field_type)
	i=19;
	set_server_bot_type_info(s,i,-1,"Gate Keeper","Gate Keeper",2,1,0,4,0);

	server[s].bot_type[i].sector[22] = 1;
	server[s].bot_type[i].sector[23] = 1;
	server[s].bot_type[i].sector[24] = 1;
	server[s].bot_type[i].sector[27] = 1;
	server[s].bot_type[i].sector[28] = 1;
	server[s].bot_type[i].sector[33] = 1;
	server[s].bot_type[i].sector[32] = 1;
	server[s].bot_type[i].sector[31] = 1;

	server[s].bot_type[i].sector[60] = 1;
	server[s].bot_type[i].sector[56] = 1;
	server[s].bot_type[i].sector[61] = 1;
	server[s].bot_type[i].sector[52] = 1;
	server[s].bot_type[i].sector[62] = 1;
	server[s].bot_type[i].sector[57] = 1;
	server[s].bot_type[i].sector[53] = 1;
	server[s].bot_type[i].sector[51] = 1;
	...
	printf("server database created- purpose:bot\n");
}

void create_server_planet_db(int i)
{
	int k=-1,z;

	server[i].home_class = 1;
	...
	set_server_planet_info(i,13,0,0,"Laius Metis","",0,"The Chambers",0,0);
	...
	set_server_planet_info(i,17,0,0,"Crontas","",0,"Resort Pub",0,0);
	...
	set_server_planet_info(i,32,0,0,"Renos Brin","",0,"Street Darbar",0,0);
	set_server_planet_info(i,33,1,0,"Velic Gate","",0,"The Gate Bar",0,0);
	set_server_planet_info(i,34,0,0,"Adeona","",0,"The Show House",0,0);

	k=0;
	server[i].planet[k].ship[0].have = 1;
	server[i].planet[k].ship[1].have = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 4;
	server[i].planet[k].gun[0] = 1;
	server[i].planet[k].gun[1] = 1;
	server[i].planet[k].gun[2] = 1;
	server[i].planet[k].gun[3] = 1;
	server[i].planet[k].gun[4] = 1;
	server[i].planet[k].missile[0] = 1;
	server[i].planet[k].missile[1] = 1;
	...
	server[i].planet[k].ship[0].have = 1;
	server[i].planet[k].ship[1].have = 1;
	server[i].planet[k].ship[2].have = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 4;
	server[i].planet[k].gun[0] = 1;
	server[i].planet[k].gun[1] = 1;
	server[i].planet[k].gun[2] = 1;
	server[i].planet[k].gun[3] = 1;
	server[i].planet[k].gun[4] = 1;
	server[i].planet[k].gun[5] = 1;
	server[i].planet[k].gun[6] = 1;
	server[i].planet[k].missile[0] = 1;
	server[i].planet[k].missile[1] = 1;
	server[i].planet[k].missile[2] = 1;
	...
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].gun[0] = 1;
	server[i].planet[k].gun[1] = 1;
	server[i].planet[k].gun[2] = 1;
	server[i].planet[k].gun[3] = 1;
	...
	server[i].planet[k].gun[5] = 1;
	server[i].planet[k].gun[6] = 1;
	server[i].planet[k].gun[7] = 1;
	server[i].planet[k].gun[8] = 1;
	server[i].planet[k].missile[0] = 1;
	server[i].planet[k].missile[1] = 1;
	server[i].planet[k].missile[2] = 1;
	server[i].planet[k].missile[3] = 1;

	k=5;
	server[i].planet[k].ship[0].have = 1;
	server[i].planet[k].ship[1].have = 1;
	server[i].planet[k].ship[2].have = 1;
	server[i].planet[k].ship[3].have = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 4;
	server[i].planet[k].gun[0] = 1;
	server[i].planet[k].gun[1] = 1;
	server[i].planet[k].gun[2] = 1;
	server[i].planet[k].gun[3] = 1;
	...
	server[i].planet[k].ship[2].have = 1;
	server[i].planet[k].ship[3].have = 1;
	server[i].planet[k].ship[4].have = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	server[i].planet[k].ship[4].max = 4;
	server[i].planet[k].gun[0] = 1;
	server[i].planet[k].gun[1] = 1;
	server[i].planet[k].gun[2] = 1;
	server[i].planet[k].gun[3] = 1;
	...
	server[i].planet[k].gun[7] = 1;
	server[i].planet[k].gun[8] = 1;
	server[i].planet[k].gun[9] = 1;
	server[i].planet[k].gun[10] = 1;
	server[i].planet[k].missile[0] = 1;
	server[i].planet[k].missile[1] = 1;
	server[i].planet[k].missile[2] = 1;
	server[i].planet[k].missile[3] = 1;
	server[i].planet[k].missile[4] = 1;

	k=13;
	for(z=0;z<=2;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=8;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=2;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	...
	k=16;
	for(z=0;z<=3;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=12;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=3;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	...
	k=17;
	for(z=0;z<=4;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=12;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=3;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	...
	k=18;
	for(z=0;z<=4;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=13;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=4;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	server[i].planet[k].ship[4].max = 7;

	k=22;
	for(z=0;z<=5;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=15;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=5;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	server[i].planet[k].ship[4].max = 7;
	server[i].planet[k].ship[5].max = 4;

	k=23;
	for(z=0;z<=5;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=15;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=6;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	...
	k=25;
	for(z=0;z<=5;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=16;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=7;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	server[i].planet[k].ship[4].max = 7;
	server[i].planet[k].ship[5].max = 7;
	...
	k=30; // helliathin
	for(z=0;z<=6;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=17;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=8;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	server[i].planet[k].ship[4].max = 7;
	server[i].planet[k].ship[5].max = 7;
	server[i].planet[k].ship[6].max = 3;

	k=31; //renos brin
	for(z=0;z<=6;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=18;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=9;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	server[i].planet[k].ship[2].max = 7;
	server[i].planet[k].ship[3].max = 7;
	server[i].planet[k].ship[4].max = 7;
	server[i].planet[k].ship[5].max = 7;
	server[i].planet[k].ship[6].max = 6;
	...
	server[i].planet[k].ship[4].max = 7;
	server[i].planet[k].ship[5].max = 7;
	server[i].planet[k].ship[6].max = 7;

	k=34; //adeona
	for(z=0;z<=1;z++) server[i].planet[k].ship[z].have = 1;
	for(z=0;z<=5;z++) server[i].planet[k].gun[z] = 1;
	for(z=0;z<=2;z++) server[i].planet[k].missile[z] = 1;
	server[i].planet[k].ship[0].max = 7;
	server[i].planet[k].ship[1].max = 7;
	...
	for(k=0;k<=2;k++)
		for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 180;
		server[i].planet[k].good_price_low[z] = 100;
		server[i].planet[k].contra_price_high[z] = 2200;
		server[i].planet[k].contra_price_low[z] = 2000;

		server[i].planet[k].good_ammount_high[z] = 5000;
		server[i].planet[k].good_ammount_low[z] = 500;
		server[i].planet[k].contra_ammount_high[z] = 300;
		server[i].planet[k].contra_ammount_low[z] = 100;
	}
	...
	for(k=19;k<=21;k++)
		for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 200;
		server[i].planet[k].good_price_low[z] = 100;
		server[i].planet[k].contra_price_high[z] = 2200;
		server[i].planet[k].contra_price_low[z] = 2000;
	...
	for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 250;
		server[i].planet[k].good_price_low[z] = 100;
		server[i].planet[k].contra_price_high[z] = 2200;
		server[i].planet[k].contra_price_low[z] = 2000;
		...
		for(z=0;z<10;z++)
	{
		...
		server[i].planet[k].good_ammount_high[z] = 50000;
		server[i].planet[k].good_ammount_low[z] = 5000;
		server[i].planet[k].contra_ammount_high[z] = 300;
		server[i].planet[k].contra_ammount_low[z] = 100;
	}

	//Azathio Zeta and Xerosis
	for(k=3;k<=4;k++)
		for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 300;
		server[i].planet[k].good_price_low[z] = 100;
		server[i].planet[k].contra_price_high[z] = 2200;
		server[i].planet[k].contra_price_low[z] = 2000;

		server[i].planet[k].good_ammount_high[z] = 4000;
		server[i].planet[k].good_ammount_low[z] = 2000;
		server[i].planet[k].contra_ammount_high[z] = 300;
		server[i].planet[k].contra_ammount_low[z] = 100;
	}
	...
	for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 100;
		server[i].planet[k].good_price_low[z] = 50;
		server[i].planet[k].contra_price_high[z] = 1000;
		server[i].planet[k].contra_price_low[z] = 200;

		server[i].planet[k].good_ammount_high[z] = 50;
		server[i].planet[k].good_ammount_low[z] = 5;
		server[i].planet[k].contra_ammount_high[z] = 20;
		server[i].planet[k].contra_ammount_low[z] = 5;
	}
	...
	for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 350;
		server[i].planet[k].good_price_low[z] = 100;
		server[i].planet[k].contra_price_high[z] = 1000;
		server[i].planet[k].contra_price_low[z] = 200;

		server[i].planet[k].good_ammount_high[z] = 300;
		server[i].planet[k].good_ammount_low[z] = 5;
		server[i].planet[k].contra_ammount_high[z] = 20;
		server[i].planet[k].contra_ammount_low[z] = 5;
	}

	//just for the ol Lonis
	k=12;
	for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 100;
		...
		server[i].planet[k].good_ammount_high[z] = 100;
		server[i].planet[k].good_ammount_low[z] = 5;
		server[i].planet[k].contra_ammount_high[z] = 20;
		server[i].planet[k].contra_ammount_low[z] = 5;
	}
	...
	for(k=13;k<=15;k++)
		for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 400;
		server[i].planet[k].good_price_low[z] = 100;
		server[i].planet[k].contra_price_high[z] = 2200;
		server[i].planet[k].contra_price_low[z] = 2000;

		server[i].planet[k].good_ammount_high[z] = 3000;
		server[i].planet[k].good_ammount_low[z] = 2000;
		server[i].planet[k].contra_ammount_high[z] = 300;
		server[i].planet[k].contra_ammount_low[z] = 100;
	}
	...
	for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 500;
		server[i].planet[k].good_price_low[z] = 100;
		server[i].planet[k].contra_price_high[z] = 1000;
		server[i].planet[k].contra_price_low[z] = 200;

		server[i].planet[k].good_ammount_high[z] = 900;
		server[i].planet[k].good_ammount_low[z] = 500;
		server[i].planet[k].contra_ammount_high[z] = 20;
		server[i].planet[k].contra_ammount_low[z] = 5;
	}
	...
	for(z=0;z<10;z++)
	{
		...
		server[i].planet[k].good_ammount_high[z] = 800;
		server[i].planet[k].good_ammount_low[z] = 400;
		server[i].planet[k].contra_ammount_high[z] = 20;
		server[i].planet[k].contra_ammount_low[z] = 5;
	}
	...
	for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 2000;
		server[i].planet[k].good_price_low[z] = 1000;
		server[i].planet[k].contra_price_high[z] = 1000;
		server[i].planet[k].contra_price_low[z] = 200;

		server[i].planet[k].good_ammount_high[z] = 20000;
		server[i].planet[k].good_ammount_low[z] = 10000;
		server[i].planet[k].contra_ammount_high[z] = 20;
		server[i].planet[k].contra_ammount_low[z] = 5;
	}
	...
	for(k=24;k<=25;k++)
		for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 700;
		server[i].planet[k].good_price_low[z] = 300;
		server[i].planet[k].contra_price_high[z] = 1000;
		server[i].planet[k].contra_price_low[z] = 200;

		server[i].planet[k].good_ammount_high[z] = 2700;
		server[i].planet[k].good_ammount_low[z] = 1000;
		server[i].planet[k].contra_ammount_high[z] = 20;
		server[i].planet[k].contra_ammount_low[z] = 5;
	}

	//banished zone planets
	for(k=30;k<=32;k++)
		for(z=0;z<10;z++)
	{
		server[i].planet[k].good_price_high[z] = 800;
		server[i].planet[k].good_price_low[z] = 200;
		server[i].planet[k].contra_price_high[z] = 2200;
		server[i].planet[k].contra_price_low[z] = 2000;
	...
	printf("server database created- purpose:planet\n");
}

void create_server_galaxy_db(int i)
{
	int k;

	//Gen zone
	k=0;
	strcpy(server[i].zone[k].name,"Gen");
	server[i].zone[k].home_class = 1;
	...
	set_server_sector_info(i,0,112,-1,0,793,-214,141,103,104,114,125,0,0,0);
	...
	set_server_sector_info(i,0,119,-1,0,1026,-339,118,132,133,120,-1,0,0,0);
	...
	set_server_sector_info(i,0,143,-1,0,761,-117,141,144,-1,-1,-1,0,0,0);
	set_server_sector_info(i,0,144,-1,0,746,-82,143,145,-1,-1,-1,0,0,0);
	set_server_sector_info(i,0,145,11,1,732,-48,144,-1,-1,-1,-1,0,0,0);
	...
	//Diaspora zone
	k=1;
	strcpy(server[i].zone[k].name,"Diaspora");
	server[i].zone[k].home_class = 0;
	...
	set_server_sector_info(i,1,32,-1,0,179,-18,33,31,37,-1,-1,2,0,0);
	set_server_sector_info(i,1,33,10,0,200,31,34,32,-1,-1,-1,2,0,0);
	...
	set_server_sector_info(i,1,37,-1,0,156,-73,30,32,-1,-1,-1,2,0,0);
	...
	//Velic zone
	k=2;
	strcpy(server[i].zone[k].name,"Velic");
	server[i].zone[k].home_class = 2;
	set_server_sector_info(i,2,0,20,0,-256,-24,1,-1,-1,-1,-1,0,0,0);
	set_server_sector_info(i,2,1,-1,0,-217,-45,0,2,-1,-1,-1,0,0,0);
	set_server_sector_info(i,2,2,-1,0,-172,-53,1,3,-1,-1,-1,0,0,0);
	...
	set_server_sector_info(i,2,8,-1,0,81,58,7,9,-1,-1,-1,0,0,0);
	set_server_sector_info(i,2,9,7,0,130,44,8,10,32,35,-1,0,0,0);
	set_server_sector_info(i,2,10,-1,0,172,26,9,11,63,-1,-1,0,0,0);
	...
	set_server_sector_info(i,2,22,-1,0,-15,-117,21,23,60,-1,-1,0,0,0);
	set_server_sector_info(i,2,23,-1,0,21,-148,22,24,29,-1,-1,0,0,0);
	set_server_sector_info(i,2,24,19,0,47,-191,23,62,33,-1,-1,0,0,0);
	set_server_sector_info(i,2,25,-1,0,-51,68,5,26,6,-1,-1,0,0,0);
	set_server_sector_info(i,2,26,-1,0,-80,107,25,27,-1,-1,-1,0,0,0);
	set_server_sector_info(i,2,27,-1,0,-126,109,26,28,43,-1,-1,0,0,0);
	set_server_sector_info(i,2,28,21,0,-163,81,27,-1,-1,-1,-1,0,0,0);
	...
	//Old Diaspora Zone
	k=3;
	strcpy(server[i].zone[k].name,"Perished");
	server[i].zone[k].home_class = 0;
	...
	set_server_sector_info(i,3,3,-1,-1,129,44,2,4,-1,-1,-1,1,0,0);
	set_server_sector_info(i,3,4,-1,0,179,44,3,-1,-1,-1,-1,1,0,0);
	...
	set_server_sector_info(i,3,99,-1,0,-313,575,98,101,-1,-1,-1,5,0,0);
	...
	set_server_sector_info(i,3,111,-1,0,199,578,112,110,-1,-1,-1,5,0,0);
	...
	set_server_sector_info(i,3,146,-1,0,-444,486,147,145,-1,-1,-1,6,0,0);
	...
	set_server_sector_info(i,3,150,150,0,-504,578,156,151,147,-1,-1,6,0,0);
	...
	set_server_sector_info(i,3,155,-1,0,-696,617,157,152,-1,-1,-1,6,0,0);
	...
	//Banished Zone
	k=4;
	strcpy(server[i].zone[k].name,"Banished");
	server[i].zone[k].home_class = 0;
	...
	printf("server database created- purpose:galaxy\n");
}

void create_server_ship_db(int i)
{
	int k=0;
	//
	strcpy(server[i].ship[k++].name,"Zephyr");
	...
	//
	strcpy(server[i].ship[k++].name,"Arachne");
	...
	//
	strcpy(server[i].ship[k++].name,"Nisus");
	...
	//
	strcpy(server[i].ship[k++].name,"Talos");
	...
	strcpy(server[i].ship[k++].name,"Nereid");
	...
	//
	strcpy(server[i].ship[k++].name,"Endymion");
	...
	//cost, exp, hull, shield, evasion, speed, range, cargo, guns, missiles, miscs
	strcpy(server[i].ship[k++].name,"Helios");
	...
	//cost, exp, hull, shield, evasion, speed, range, cargo, guns, missiles, miscs
	strcpy(server[i].ship[k++].name,"Erinyes");
	...
	//cost, exp, hull, shield, evasion, speed, range, cargo, guns, missiles, miscs
	strcpy(server[i].ship[k++].name,"Andros"); //8
	...
	printf("server database created- purpose:ship\n");
}

void create_server_gun_db(int i)
{
	...
	printf("server database created- purpose:gun\n");
}

void create_server_missile_db(int i)
{
	...
	printf("server database created- purpose:missile\n");
}

void create_server_satellite_db(int s)
{
	int i, k, gun_id, missile_id, l, g;

      //int s, int p, int level, int g, int gun, int missile
	return;
      //Gen Zone
      //Gen Grayl
	set_server_satellite_default(s,0,4,0,4,1);
      //Gen Irium
	set_server_satellite_default(s,1,4,0,4,1);
      //Gen Pelein
	set_server_satellite_default(s,2,4,0,4,1);
      //Seira
	set_server_satellite_default(s,8,4,1,5,1);
      //Reynek
	set_server_satellite_default(s,9,4,1,5,1);
      //Lonis
	set_server_satellite_default(s,12,6,6,5,2);

      //Nuet Zone
      //Azathio Zeta
	set_server_satellite_default(s,3,6,1,6,2);
      //Xerosis
	set_server_satellite_default(s,4,6,2,8,3);
      //Enktopis
	set_server_satellite_default(s,5,6,6,8,3);
      //Jen Cando
	set_server_satellite_default(s,10,8,3,10,4);

      //Diaspora Zone
      //Laus Metis
	set_server_satellite_default(s,13,4,13,8,2);
      //Seejen
	set_server_satellite_default(s,14,4,13,8,2);
      //Tyros
	set_server_satellite_default(s,15,4,13,8,2);
      //Jen Kayle
	set_server_satellite_default(s,16,5,12,12,3);
      //Crontas
	set_server_satellite_default(s,17,5,6,12,3);
      //Hy Syng
	set_server_satellite_default(s,18,5,6,13,4);
      //Daynow
	set_server_satellite_default(s,22,6,4,15,5);
      //Naykon
	set_server_satellite_default(s,23,6,4,15,6);
      //Endystation
	set_server_satellite_default(s,24,7,4,15,5);
      //Dysilica
	set_server_satellite_default(s,25,7,4,16,7);
      //Kaydarin
	set_server_satellite_default(s,26,8,4,16,7);

      //Velic Zone
      //Velic Carden
	set_server_satellite_default(s,19,4,0,4,1);
      //Velic Grindow
	set_server_satellite_default(s,20,4,0,4,1);
      //Velic Vel
	set_server_satellite_default(s,21,4,0,4,1);
}
